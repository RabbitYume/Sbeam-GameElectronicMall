				...
				<div class="nav-right-part nav-right-part-desktop">
					<ul>
						<li><a href="${pageContext.request.contextPath}/findAllShopcar"><img src="assets/img/icon/2.png"
								alt="icon"></a></li>
						<li><a class="search" href="#"><img src="img/icon/1.png"
								alt="icon"></a></li>
			...
			<div class="row justify-content-center">
				<div class="col-xl-7 col-lg-10 text-center">
					<div class="sign-in-area">
						<h2>注册账户</h2>
						<form class="contact-form-wrap" action="${pageContext.request.contextPath }/registered"
							method="post">
							<div class="single-input-wrap input-group">
								<label for="inp-1">用户名</label> <input id="inp-1" name="username" type="text"
									class="form-control" placeholder="输入您的用户名">
							</div>
							<div class="single-input-wrap input-group">
								<label for="inp-2">密码</label> <input id="inp-2" name="userpwd" type="password"
									class="form-control" placeholder="输入您的密码">
							</div>
							<button class="btn btn-base w-100">注册</button>
							<p>
								您是否已有账户？ <a href="userlogin.jsp">登录</a>
							</p>
						</form>
					</div>
				</div>
