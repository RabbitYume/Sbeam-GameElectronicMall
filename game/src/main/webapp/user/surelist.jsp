...
<%
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
			+ path + "/";
	int gameid = Integer.parseInt(request.getParameter("gameid"));//用request得到
	request.setAttribute("gameid", gameid);
	double price = Double.parseDouble(request.getParameter("price"));//用request得到
	request.setAttribute("gameprice", price);
	String gamename = request.getParameter("gamename");//用request得到
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container nav-container">
				...
				<div class="nav-right-part nav-right-part-desktop">
					<ul>
						<li><a
							href="${pageContext.request.contextPath}/findAllShopcar"><img
						...
						<div class="widget widget-cart">
							<div class="widget-cart-inner text-center">
								...
								<form class="contact-form-wrap"
									action="${pageContext.request.contextPath }/insertNowOrder"
									method="post">
									<table id="customer-list" class="table table-striped">
										...
										<tbody>
											<tr>
												<td><input name="gameid" type="text"
													value="<%=gameid%>" readonly="true"></td>
												<td><input name="gamename" type="text"
													value="<%=gamename%>" readonly="true"></input></td>
												<td><input name="price" type="text" value="<%=price%>"
													readonly="true"></td>
												<td>
										</tbody>
									</table>
									<div align="left">
										<p class="ratting" style="font-size: 23px;">
											总金额：<%=price%></p>
									</div>
									<input type="submit" value="结算" class="btn btn-base"></input>>
							</div>
							</form>
						</div>
					</div>
