			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="findAll" class="active"> 用户管理</a></li>
					</ol>
					<!-- /breadcrumb -->
				</div>
				<!-- /dashboard -->
					...
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<div class="table-responsive">
												...
												<td>
													<ul>
														<li style="list-style:none;display:inline;"><a
															href="admin/userupdate.jsp?id=${row.id}&username=${row.username}"
															class="btn btn-xs btn-edit bg-purple hidden-xs hidden-sm">
																编辑</a></li>
														<li style="list-style:none;display:inline;"><a
															href="${pageContext.request.contextPath}/delete?id=${row.id}"
								...
								<div align="right">
									<page:page url="${pageContext.request.contextPath }/findAll" />
								</div>
							</div>
							<!-- /table-responsive -->
						</div>
