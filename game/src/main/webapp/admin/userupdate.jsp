			...
			<div class="container-fluid">
				<div id="navbar-header">
					...
					<form class="navbar-form navbar-left hidden-xs"
						action="${pageContext.request.contextPath }/findLikeName"
						method="post">
					...
					<ul class="nav navbar-nav navbar-right">
						<!-- 退出 -->
						<li class="dropdown user-menu"><a href="${pageContext.request.contextPath}/logout"
			...
			<div id="#sidebar-navbar"
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#" class="chevron"><i class="fa fa-sitemap"
						...
						<ul class="nav nav-second-level">
							<ul class="nav nav-second-level">
								<li><a href="${pageContext.request.contextPath}/findAllSupplier">游戏厂商管理</a></li>
							</ul>
							<!-- /nav-second-level -->
						</ul> <!-- /nav-second-level --></li>
					<!-- /li dropdown -->
					...
					<li><a href="#" class="chevron active"><i
						...
						<ul class="nav nav-second-level">
							<li><a href="${pageContext.request.contextPath}/findAll"
								class="active">用户管理</a></li>
						</ul> <!-- /nav-second-level --></li>
					<!-- /li 用户 -->
				</ul>
				<!-- /side-menu -->
			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">用户编辑</a></li>
					</ol>
					<!-- /breadcrumb -->
				...
				<div class=" col-xs-12">
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<form data-toggle="validator" action="${pageContext.request.contextPath }/update" method="post">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-addon bg-purple" id="basic-addon1"><i
											...
											class="form-control" name="username" value="<%=username%>" id="Name" placeholder="用户名"
											data-error="Your name is invalid" readonly="true" required>
									</div>
									<!-- /input-group -->
								</div>
								<!-- /form-group -->
								...
								<div class="form-group m-b-0">
									<div class="row">
										<div class="form-group col-sm-8">
											...
											<div class="input-group">
												<span class="input-group-addon bg-purple" id="basic-addon3"><i
													class="fa fa-key" aria-hidden="true"></i> </span> <input
													type="text" data-minlength="6" class="form-control"
													id="inputPassword" name="userpwd" placeholder="密码" required>
											</div>
											<!-- /input-group -->
										</div>
										<!-- /form-group -->
