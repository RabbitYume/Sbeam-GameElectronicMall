				...
				<div class="col-xs-12">
					<div class="panel">
						...
						<div class="panel-body m-t-0">
											...
											<td>
												<ul>
													<li style="list-style: none; display: inline;"><a
														href="${pageContext.request.contextPath}/updateGame?id=${row.id}&gamename=${row.gamename}&price=${row.price}
														&suppliername=${row.suppliername}&supplierid=${row.supplierid}&typeid=${row.typeid}&type=${row.type}"
							...
							<div align="right">
								<page:page url="${pageContext.request.contextPath }/findAllGame" />
							</div>
						</div>
						<!-- /table-responsive -->
					</div>
