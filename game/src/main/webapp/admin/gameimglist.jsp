			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="findAllGameImg" class="active"> 游戏图片管理</a></li>
					</ol>
					<!-- /breadcrumb -->
				</div>
				<!-- /dashboard -->
					...
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<div class="table-responsive">
								<div align="right">
									<a href="admin/gameimginsert.jsp"
								...
								<tbody>
									<c:forEach items="${page.rows }" var="row">
										<tr>
											<td>${row.id }</td>
											<td>${row.gamename }</td>
											<td><img src="${row.imgurl}" height="60" width="120"></td>
											<td>
												<ul>
													<li style="list-style: none; display: inline;"><a
														href="admin/gameimgupdate.jsp?id=${row.id}&gamename=${row.gamename}"
														class="btn btn-xs btn-edit bg-purple hidden-xs hidden-sm">
															更换</a></li>
													<li style="list-style: none; display: inline;"><a
														href="${pageContext.request.contextPath}/deleteGameimg?id=${row.id}&gamename=${row.gamename}"
							...
							<div align="right">
								<page:page
									url="${pageContext.request.contextPath }/findLikeGameImgName" />
							</div>
						</div>
						<!-- /table-responsive -->
					</div>
