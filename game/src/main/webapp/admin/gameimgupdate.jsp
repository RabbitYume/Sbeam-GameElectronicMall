			...
			<div class="container-fluid">
				<div id="navbar-header">
					...
					<form class="navbar-form navbar-left hidden-xs"
						action="${pageContext.request.contextPath }/findLikeGameImgName"
						method="post">
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#" class="chevron active"><i
						...
						<ul class="nav nav-second-level">
							...
							<li><a
								href="${pageContext.request.contextPath}/findAllGameImg"
								class="active">游戏图片管理</a></li>
			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="#" class="active">修改游戏图片</a></li>
					</ol>
					<!-- /breadcrumb -->
					...
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<form data-toggle="validator"
								action="${pageContext.request.contextPath }/updateGameimg"
								...
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-addon bg-purple" id="basic-addon1"><i
											...
											class="form-control" value="<%=gamename%>" id="Name" name="gamename"
								...
								<div class="form-group">
									...
									<label for="yourAnswer" class="control-label">上传图片</label>
									<div class="input-group">
										<span class="input-group-addon bg-purple" id="basic-addon6"><i
											class="fa fa-reply" aria-hidden="true"></i> </span> <input
											type="file" name="pictureFile" data-minlength="6" class="form-control"
											id="yourAnswer" placeholder="Picture" required>
									</div>
									<!-- /input-group -->
