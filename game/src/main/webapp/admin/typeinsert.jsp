			...
			<div class="container-fluid">
				<div id="navbar-header">
					...
					<form class="navbar-form navbar-left hidden-xs"
						action="${pageContext.request.contextPath }/findLikeTypeName"
						method="post">
				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#" class="chevron active"><i
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="${pageContext.request.contextPath}/findAllType" class="active">游戏类型管理</a></li>
			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="typeinsert.jsp" class="active">添加游戏类型</a></li>
					</ol>
					<!-- /breadcrumb -->
				...
				<div class=" col-xs-12">
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<form data-toggle="validator" action="${pageContext.request.contextPath }/insertType" method="post">

								<div class="form-group">
									<label for="Name" class="control-label">游戏类型</label>
									<div class="input-group">
										<span class="input-group-addon bg-purple" id="basic-addon1"><i
											class="fa fa-user" aria-hidden="true"></i></span> <input type="text"
											class="form-control" id="Name" name="type" placeholder="游戏类型"
