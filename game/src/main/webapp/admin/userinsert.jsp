			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="userinsert.jsp" class="active">添加用户</a></li>
					</ol>
					<!-- /breadcrumb -->
				...
				<div class=" col-xs-12">
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<form data-toggle="validator" action="${pageContext.request.contextPath }/insert" method="post">
								...
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-addon bg-purple" id="basic-addon1"><i
											...
											class="form-control" id="Name" name="username" placeholder="用户名"
