			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="findAllType" class="active"> 游戏类型管理</a></li>
					</ol>
					<!-- /breadcrumb -->
				</div>
				<!-- /dashboard -->
					...
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<div class="table-responsive">
												...
												<td>
													<ul>
														<li style="list-style:none;display:inline;"><a
															href="admin/typeupdate.jsp?id=${row.id}&type=${row.type}"
															class="btn btn-xs btn-edit bg-purple hidden-xs hidden-sm">
																编辑</a></li>
														<li style="list-style:none;display:inline;"><a
															href="${pageContext.request.contextPath}/deleteType?id=${row.id}"
								...
								<div align="right">
									<page:page url="${pageContext.request.contextPath }/findLikeTypeName" />
								</div>
							</div>
							<!-- /table-responsive -->
						</div>
