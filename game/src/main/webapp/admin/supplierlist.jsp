			...
			<div class="row">
				<div class="col-xs-12 dashboard-header">
					...
					<ol class="breadcrumb">
						...
						<li><a href="findAllSupplier" class="active"> 游戏厂商管理</a></li>
					</ol>
					<!-- /breadcrumb -->
				</div>
				<!-- /dashboard -->
					...
					<div class="panel">
						...
						<div class="panel-body m-t-0">
							<div class="table-responsive">
								<div align="right">
									<a href="admin/supplierinsert.jsp"
												...
												<td>
													<ul>
														<li style="list-style:none;display:inline;"><a
															href="admin/supplierupdate.jsp?id=${row.id}&suppliername=${row.suppliername}"
															class="btn btn-xs btn-edit bg-purple hidden-xs hidden-sm">
																编辑</a></li>
														<li style="list-style:none;display:inline;"><a
															href="${pageContext.request.contextPath}/deleteSupplier?id=${row.id}"
								...
								<div align="right">
									<page:page url="${pageContext.request.contextPath }/findLikeSupplierName" />
								</div>
							</div>
							<!-- /table-responsive -->
						</div>
