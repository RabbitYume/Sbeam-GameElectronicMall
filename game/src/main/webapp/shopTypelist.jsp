			...
			<div class="row">
				<div class="col-lg-8 order-lg-last">
						...
						<div class="row">
							...
							<c:forEach items="${page.rows }" var="row">
								<div class="all-isotope-item col-lg-6 col-sm-6">
									<div class="thumb">
										<a class="btn btn-white" href="${pageContext.request.contextPath }/buyNow?gameid=${row.id }&gamename=${row.gamename }&price=${row.price}">立即购买</a> <img
					...
					<div class="pagination-wrap text-center mt-2">
						<page:page
							url="${pageContext.request.contextPath }/userFindByGameType" />
					</div>
				</div>
